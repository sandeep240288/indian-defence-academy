      ...
      <section class="lg:px-[15%] px-[5%] pt-20">
        ...
        <div class="lg:mt-20 mt-10">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-4 gap-10 lg:mt-20">
            <template v-for="(p, i) in filterProducts" :key="`product-${i}-${p.id}`">
              <Discount
              ...
              >
                ...
                <div class="p-3">
                  ...
                  <p class="font-bold text-sm mt-2">{{ formatPrice(p.price) }}</p>
                </div>
              </NuxtLink>
            </template>
          </div>
