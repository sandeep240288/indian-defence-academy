<template>
  ...
  <section class="bg-white pt-10 pb-20 px-20 lg:py-[120px] overflow-hidden relative z-10">
    <div class="container">
      <div class="flex flex-wrap lg:justify-between -mx-4">
        <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
          <div class="max-w-[570px] mb-12 lg:mb-0">
            <h2 class="text-dark mb-6 uppercase font-bold text-[20px] sm:text-[30px] lg:text-[30px] xl:text-[30px]">GET
              IN TOUCH WITH US</h2>
            <p class="text-base text-body-color leading-relaxed mb-9"></p>
            <div class="flex mb-8 max-w-[370px] w-full">
              ...
              <div class="w-full">
                ...
                <p class="text-base text-body-color">
                  दि इंडियन डिफेंस एकेडमी
                  खुर्दही बाजार, सुल्तानपुर रोड ,लखनऊ-226001
                </p>
              </div>
            </div>
            <div class="flex mb-8 max-w-[370px] w-full">
              ...
              <div class="w-full">
                ...
                <p class="text-base text-body-color"> <span itemprop="telephone"><a href="tel:+916307658884">
                      +916307658884</a></span></p>
                <p class="text-base text-body-color"> <span itemprop="telephone"><a href="tel:+918604719945">
                      +918604719945</a></span></p>
              </div>
            </div>
            <div class="flex mb-8 max-w-[370px] w-full">
              <div
              ...
              <div class="w-full">
                ...
                <p class="text-base text-body-color">
                  <a href="mailto:theindiandefenceacademy@gmail.com">theindiandefenceacademy@gmail.com</a>
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
          <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
            <form>
              ...
              <div>
                <button type="submit"
                  class="w-full text-black bg-primary rounded border border-primary p-3 transition hover:bg-opacity-90">Send
                  Message</button>
              </div>
            </form>
          </div>
