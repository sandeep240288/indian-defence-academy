      ...
      <div class="flex flex-wrap lg:justify-between -mx-4">
        <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
          <div class="max-w-[570px] mb-12 lg:mb-0">
            <h2 class="text-dark mb-6 uppercase font-bold text-[20px] sm:text-[30px] lg:text-[30px] xl:text-[30px]">
              GET
              IN TOUCH WITH US
            </h2>
              ...
              <div class="w-full">
                ...
                <p class="text-base text-body-color">
                  <span itemprop="telephone">
                    <a href="tel:+916307658884">+916307658884</a>
                  </span>
                </p>
                <p class="text-base text-body-color">
                  <span itemprop="telephone">
                    <a href="tel:+918604719945">+918604719945</a>
                  </span>
                </p>
              </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
          <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
            <form name="contactusform" method="post" autocomplete="on" @submit.prevent="submitForm()"
              ...
              <div>
                <button type="submit"
                  class="w-full text-black bg-primary rounded border border-primary p-3 transition hover:bg-opacity-90">
                  Send
                  Message
                </button>
              </div>
